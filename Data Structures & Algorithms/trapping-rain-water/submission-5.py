...
class Solution:
    def trap(self, height: List[int]) -> int:
        ...
        #Note: Don't forget this : brute force maximum finding is O(n square)
...
#The Formula that you need to notice here is:
#Amount of water that will at an index is :
# Min (Left Max height for an index, Right Max height for an index) - Height of existing wall in that index
