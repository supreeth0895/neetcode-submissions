#HARD LEVEL I felt - Used some help to complete coding
#Basically Store frequency in a Map, and if sum of Frequency of all chars except most repeating is >k, you move the left pointer of window.
#Else you keep moving right pointer of window.
