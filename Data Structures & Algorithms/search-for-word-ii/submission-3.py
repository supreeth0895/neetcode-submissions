...
# Do DFS from every index of the graph and compare it with Trie. Stop the dfs path if it no longer matches the Trie.
# The advantage of trie is that, without a Trie, We'd have to manually maintain multiple index for each WORD or do 1 dfs per cell PER WORD. That's crazy work
# With a Trie , It's 1 DFS per Cell, For ALL Words combined. (4pow(mn))*(num_words) = (k)(4**mn)
