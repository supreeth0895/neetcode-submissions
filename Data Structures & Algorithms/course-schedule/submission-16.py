class Solution:
    def canFinish(self, numCourses: int, prerequisites: List[List[int]]) -> bool:
        ...
        def dfs(course):
            ...
            # visited.add(course) - Actually we don't care if we visit all nodes. Only if  there is cycle. There might be unconnected graph. So we don't care if we visit all nodes.
